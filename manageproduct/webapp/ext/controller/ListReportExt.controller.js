sap.ui.define(
    "ux.manageproduct.ext.controller.ListReportExt", [
        "sap/ui/model/Filter", 
        ...
        return {
            getCustomAppStateDataExtension: function (oCustomData) {
                ...
                if (oCustomData) {
                    var oCustomField1 = this.oView.byId("idSupplier");
                    if (oCustomField1) {
            ...
            restoreCustomAppStateDataExtension: function (oCustomData) {
                ...
                if (oCustomData) {
                    if (oCustomData.onUIFilter) {
                        var oComboBox = this.oView.byId("idSupplier");
            ...
            onBeforeRebindTableExtension: function(oEvent) {
                ...
                if (oSmartFilterBar instanceof SmartFilterBar) {
                    var oCustomControl = oSmartFilterBar.getControlByKey("SupplierId");
