sap.ui.define([
	...
	return Opa5.extend("ux.freemangeproduct.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ux/freemangeproduct/localService/mockserver"], function (mockserver) {
