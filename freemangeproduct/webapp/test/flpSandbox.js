		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Product v2",
									"targetURL": "#ManageProductv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ManageProductv2-display": {
								"semanticObject": "ManageProductv2",
								"action": "display",
								"description": "A Fiori application. Free style approch",
								"title": "Manage Product v2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ux.freemangeproduct",
									"url": sap.ui.require.toUrl("ux/freemangeproduct")
								}
							}
						}
					}
